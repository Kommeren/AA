...
tests="2_local_search_test bounded_degree_mst_test capacitated_voronoi_test cycle_canceling_test dreyfus_wagner_test facility_location_test
       ...
       k_median_test k_median_solution_adapter_test ir_steiner_tree_test local_search_multi_solution_test local_search_multi_solution_lambdas_test local_search_test
