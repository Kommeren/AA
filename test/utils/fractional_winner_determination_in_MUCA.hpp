...
#ifndef  fractional_winner_determination_in_MUCA_UTILS
#define  fractional_winner_determination_in_MUCA_UTILS
...
void check_fractional_determine_winners_in_demand_query_auction(
   ...
   using Traits = paal::auctions::demand_query_auction_traits<decltype(auction)>;
   ...
   paal::auctions::fractional_determine_winners_in_demand_query_auction(
      ...
      boost::make_function_output_iterator([&](Assignment a)
      {
         ...
         social_welfare += frac * valuation.template call<paal::auctions::value_query>(bidder, item_set);
         for (auto item: items) {
...
#endif   /* fractional_winner_determination_in_MUCA_UTILS  */
