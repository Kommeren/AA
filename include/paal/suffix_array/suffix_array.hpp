 ...
 * @param Letter b1
 * @param int b2
 * @brief return true if pair (a1,a2) is smaller than pair (b1,b2) in lexicographic order
 * and false otherwise
 * @tparam Letter
 */
//class suffixArray{
 ...
 * @param Letter b2
 * @param int b3
 * @brief return true if triple (a1,a2,a3) is smaller than triple (b1,b2,b3) in lexicographic order
 * and false otherwise
 * @tparam Letter
 */
template<typename Letter>
