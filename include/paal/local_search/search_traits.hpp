...
struct search_components_traits {
    typedef typename data_structures::component_traits<search_components>::template type<GetMoves>::type GetMovesT;
 ...
 * @tparam Solution
 */
template <typename GetMoves, typename Solution>
...
struct move_type : public move_type_from_get_moves<
            typename search_components_traits<
                SearchComponents>::GetMovesT, Solution> {
};
...
class fitness_from_gain_and_get_moves {
    typedef typename move_type_from_get_moves<GetMoves, Solution>::value_type Move;
public:
 ...
 */
template <typename SearchComponents, typename Solution>
struct fitness :  fitness_from_gain_and_get_moves<typename search_components_traits<
                            SearchComponents>::GainT,
                          typename search_components_traits<
                            SearchComponents>::GetMovesT,
                          Solution> {
};
