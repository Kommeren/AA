...
public:
    ...
    shortest_superstring(const Words& words):
          ...
          m_prefix_tree(m_length,m_suffix_array,m_sum_words,m_lcp,m_length_suffix_word) {
...
private:
    ...
    void initialize(const Words& words){
        ...
        for(auto const & word : words){
            ...
            for(auto letter : word) {
                ...
                m_length_suffix_word[globalLetterId] = wordSize - noLetterInWord;
                ++noLetterInWord;
            }
    ...
    void join_word(int ps,int overlap){
        ...
        int prefix=m_prefix_tree.get_prefixequal_to_suffix(suffix,m_last_word_in_block_to_first_word_in_block[ps]);
        ...
        m_last_word_in_block_to_first_word_in_block[m_first_word_in_block_to_last_word_in_block[prefix]]=
                m_last_word_in_block_to_first_word_in_block[ps];
        m_first_word_in_block_to_last_word_in_block[m_last_word_in_block_to_first_word_in_block[prefix]]=
                prefix;
    ...
    std::vector<int> m_first_word_in_block_to_last_word_in_block,m_last_word_in_block_to_first_word_in_block,
    m_pos_to_word,m_length_words,m_length_suffix_word,
    m_suffix_array,m_lcp,m_rank,m_res,m_long_words;
...
decltype(std::declval<detail::shortest_superstring<Words>>().get_solution()){
