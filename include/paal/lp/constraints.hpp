...
private:
    ...
    template <typename CorrectTag>
    void assert_bound_type_tag() const {
...
public:
    ...
    double_bounded_expression(const single_bounded_expression<LowerBoundTag, BoundDirection> & expr,
                              double ub = lp_traits::PLUS_INF) :
    ...
    template <typename BoundDirection>
    double_bounded_expression(const single_bounded_expression<UpperBoundTag, BoundDirection> & expr,
                              double lb = lp_traits::MINUS_INF) :
...
inline single_bounded_expression<LowerBoundTag, LeftBoundTag> operator<=(double val, const linear_expression & expr) {
    return single_bounded_expression<LowerBoundTag, LeftBoundTag>(val, expr);
}

/// linear_expression >= double operator.
inline single_bounded_expression<LowerBoundTag, RightBoundTag> operator>=(const linear_expression & expr, double val) {
...
/// double >= linear_expression operator.
inline single_bounded_expression<UpperBoundTag, LeftBoundTag> operator>=(double val, const linear_expression & expr) {
    return single_bounded_expression<UpperBoundTag, LeftBoundTag>(expr, val);
}

/// linear_expression <= double operator.
inline single_bounded_expression<UpperBoundTag, RightBoundTag> operator<=(const linear_expression & expr, double val) {
...
inline double_bounded_expression operator>=(double val, const single_bounded_expression<LowerBoundTag, RightBoundTag> & expr) {
    return double_bounded_expression(expr, val);
}

/// left_lower_bound_expression <= double operator.
inline double_bounded_expression operator<=(const single_bounded_expression<LowerBoundTag, LeftBoundTag> & expr, double val) {
    return double_bounded_expression(expr, val);
}

/// double <= right_upper_bound_expression operator.
inline double_bounded_expression operator<=(double val, const single_bounded_expression<UpperBoundTag, RightBoundTag> & expr) {
    return double_bounded_expression(expr, val);
}

/// left_upper_bound_expression >= double operator.
inline double_bounded_expression operator>=(const single_bounded_expression<UpperBoundTag, LeftBoundTag> & expr, double val) {
    return double_bounded_expression(expr, val);
}

/// double == linear_expression operator.
inline double_bounded_expression operator==(double val, const linear_expression & expr) {
    return double_bounded_expression(expr, val, val);
}

/// linear_expression == double operator.
inline double_bounded_expression operator==(const linear_expression & expr, double val) {
    return double_bounded_expression(expr, val, val);
}
