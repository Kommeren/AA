...
//! [CFL Search Example]
    ...
    //search
    facility_location_local_search_simple(sol, default_remove_fl_components<int>::type(), default_add_fl_components<int>::type(), default_swap_fl_components<int>::type());
